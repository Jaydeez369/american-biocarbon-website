...
const DATA = {
  ...
  daily:{
    ...
    days:[
      ...
      { d:2, wk:"Week 1 · Build the machine", theme:"Proof library + list foundation",
        ...
        lanes:[
          {k:"product", items:[
            {t:"Company/product discovery — lab analyses, tech reports, prior-sales proof, feedstock story", o:"Victor + Daniel", pri:"P0", del:"Proof library"},
            {t:"Product photography — close-ups, bagged samples, facility/process shots", o:"Victor + Daniel", pri:"P1", del:"Photo set"}]},
          {k:"bizdev", items:[
      ...
      { d:3, wk:"Week 1 · Build the machine", theme:"SKUs, collateral & contacts",
        ...
        lanes:[
          {k:"product", items:[
            {t:"Create 2 sample SKUs in Shopify (Pellets 1 lb, Biochar 8 oz)", o:"Victor + Daniel", pri:"P0", del:"Variant IDs to Jesse"},
            {t:"Sample/product testing — absorbency + water-holding, claim-safe", o:"Victor + Daniel", pri:"P1", del:"Test result sheet"}]},
          {k:"bizdev", items:[
      ...
      { d:4, wk:"Week 1 · Build the machine", theme:"Kits & wiring",
        ...
        lanes:[
          {k:"product", items:[
            {t:"Wire Shopify variant IDs into site sample forms; test request e2e", o:"Victor + Daniel", pri:"P0", del:"Forms route to Jesse+Victor+Daniel"}]},
          {k:"bizdev", items:[
      ...
      { d:5, wk:"Week 1 · Build the machine", theme:"Soft launch + week-1 gate",
        ...
        lanes:[
          ...
          {k:"product", items:[
            {t:"Stage approved site in Shopify (publish post-approval)", o:"Victor + Daniel", pri:"P1", del:"Production site staged"}]},
          {k:"bizdev", items:[
      ...
      { d:8, wk:"Week 2 · Launch at volume", theme:"First calls & trials",
        ...
        lanes:[
          {k:"bizdev", items:[
            {t:"Run discovery/technical calls; capture trial success criteria per account", o:"Jesse + Victor + Daniel", pri:"P0", del:"Trials defined"}]},
          {k:"outreach", items:[
            {t:"Iterate copy from reply data; A/B round 2", o:"Jesse", pri:"P1", del:"Higher reply rate"}]},
          {k:"product", items:[
            {t:"Support trials; document sample success criteria (repeatable)", o:"Victor + Daniel", pri:"P0", del:"Repeatable trials"}]},
          {k:"media", items:[
      ...
      { d:9, wk:"Week 2 · Launch at volume", theme:"Convert biochar wins → paid orders",
        ...
        lanes:[
          ...
          {k:"product", items:[
            {t:"Turn a win into a case-study draft (with permission)", o:"Victor + Daniel", pri:"P1", del:"Case study v1"}]},
          {k:"media", items:[
      ...
      { d:10, wk:"Week 2 · Launch at volume", theme:"Two-week review & lock cadence",
        ...
        lanes:[
          ...
          {k:"media", items:[
            {t:"Plan Week-3 media calendar; line up planned rebrand (name TBD) teaser (~Aug 17)", o:"Jesse", pri:"P2", del:"Media calendar"}]},
          {k:"product", items:[
            {t:"Advance largest LOIs toward binding Q4 offtake", o:"Victor + Daniel", pri:"P1", del:"Offtake pipeline"}]},
        ]},
    ],
  },
  ...
  roadmap:[
    { phase:"First 7 days", note:"Two lanes running in parallel: Jesse builds the outbound machine; Victor gets the product, proof, and website launch-ready. Check items off as they land — they persist.", tasks:[
      ...
      { t:"Create 2 sample SKUs in Shopify (Pellets 1 lb, Biochar 8 oz)", o:"Victor + Daniel", pri:"P0", eff:"S", out:"Sample orders fulfillable", dep:"Shopify admin", app:"Shopify", del:"SKUs live; variant IDs to Jesse" },
      { t:"Install approved website into Shopify (stage → publish over current site)", o:"Victor + Daniel", pri:"P1", eff:"L", out:"New site live on Shopify", dep:"Approval + certs", app:"Shopify", del:"Production site (post-approval)" },
    ...
    { phase:"Days 31–60", tasks:[
      ...
      { t:"Ship the planned rebrand (name TBD) (~Aug 17) — site + collateral + signatures", o:"Victor + Jesse", pri:"P0", eff:"M", out:"Unified brand", dep:"Rebrand asset pack", app:"Collateral", del:"Rebrand live" },
      ...
      { t:"Advance largest LOIs toward binding Q4 offtake", o:"Victor + Daniel", pri:"P1", eff:"L", out:"Offtake pipeline", dep:"Q4 capacity data", app:"Offtake pipeline", del:"Offtake talks" },
    ]},
