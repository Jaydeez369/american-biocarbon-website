...
const DATA = {
  ...
  segments: [
    ...
    },
    {
      ...
      valueProp:"Bagasse biochar screens clean into blends and holds up to ~3–3.5x its weight in water, firming up moisture performance in sandy and premium mixes, with inherent nutrients and an OMRI/carbon-negative story that lifts the blend's positioning.",
      ...
      proof:["IBI/OMRI docs","Water-holding (up to 3–3.5x) tech report","Spec sheet + SDS","Sample bag","Compost cycle-time data (if they cure feedstock)"],
    ...
    },
    {
      ...
      proof:["Up to 5:1 vs 2.5:1 spec","SDS","Absorbency demo","Cost-per-gallon calc"],
    ...
    },
    {
      ...
      proof:["up to 5:1 absorbency","SDS","Field demo","Cost calc"],
  ...
  personas: [
    ...
    { id:"procurement", name:"Industrial Procurement Manager", seg:"Remediation/oilfield",
      ...
      needs:"SDS, absorbency proof (up to 5:1), trial, disposal path",
  ...
  messaging: {
    ...
    productPos:[
      { p:"Agricultural biochar", m:"Honeycomb bagasse structure → up to ~3–3.5x water-holding, inherent NPK + Ca/Mg, OMRI/IBI certified. A conditioner AND a nutrient-bearing matrix, not just black carbon." },
      ...
      { p:"Absorbent pellets", m:"Up to 5:1 absorption vs ~2.5:1 for wood, fewer bags per spill, lower disposal volume, plant-based & carbon-neutral. Spill, leachate, oilfield fluid, disaster." },
    ...
    comparisons:[
      ...
      { vs:"vs Wood/clay absorbents", win:"Up to 5:1 vs 2.5:1 absorbency; plant-based, carbon-neutral; lower disposal volume per gallon captured" },
  ...
  outreach:[
    { seg:"Soil Blenders", persona:"Ops Manager",
      steps:[
        ...
        { t:"Email 2 · Day 4 (value)", b:"Subject: the water-holding number\n\n{First}, quick proof: our bagasse biochar's honeycomb pore structure holds up to ~3–3.5x its weight in water (technical report attached), vs ~2x for typical wood biochar. That's the difference blenders feel in sandy mixes.\n\nWant a sample to test? Just need your best ship-to." },
    ...
    { seg:"Remediation / Oilfield", persona:"Procurement Manager",
      steps:[
        { t:"Email 1 · Day 0", b:"Subject: up to 5:1 absorbent, fewer bags per job\n\nHi {First}, VEJ makes a plant-based bagasse absorbent that soaks up to ~5:1 vs ~2.5:1 for wood pellets. Fewer bags per spill, lower disposal volume, carbon-neutral. SDS available.\n\nWant a head-to-head absorbency demo or a trial pallet on your next job?" },
        ...
        { t:"Voicemail", b:"{First}, {Me} with VEJ, 555-xxx. Plant-based absorbent, up to 5:1 soak vs 2.5:1 for wood, SDS ready. I'll email the spec, happy to do a demo or trial pallet on your next job." },
        { t:"LinkedIn note", b:"Hi {First}, we make an up-to-5:1 bagasse absorbent (vs 2.5:1 wood) for spill/fluid remediation. Can I send the SDS + set up a quick demo?" },
        { t:"Email 2 · Day 3", b:"Subject: cost per gallon captured\n\n{First}, the number that matters: at up to ~5:1, you capture the same spill with far fewer bags than wood or clay, so cost-per-gallon and disposal volume both drop. Attached: SDS + a cost-per-gallon comparison. Want a trial pallet staged for the next job?" },
    ...
    { seg:"Landfill / Public Works", persona:"Ops / EHS Director",
      steps:[
        { t:"Email 1 · Day 0", b:"Subject: leachate & spill absorbent, pilot for next cycle\n\nHi {First}, VEJ makes a plant-based bagasse absorbent (up to 5:1) for leachate control and spill response, with SDS and certifications. Several ops teams pilot it to cut moisture-handling cost and strengthen sustainability reporting.\n\nCan I scope a pilot aligned to your budget cycle?" },
  ...
  deck:[
    ...
    { s:"Why bagasse beats wood", p:"Core differentiation", b:["Ordered honeycomb pore structure","up to ~3–3.5x water-holding vs ~2x wood","Inherent NPK + Ca/Mg; up to 5:1 absorbency vs 2.5:1"], cta:"-" },
    ...
    { s:"Segment fit (tailor)", p:"Make it about them", b:["Blenders: moisture + organic SKU","Distributors: differentiated line + margin","Industrial: up to 5:1 absorbency + disposal savings"], cta:"-" },
  ...
  calculators:[
    ...
    { id:"absorbent", name:"Absorbent Cost-per-Gallon", inputs:["Spill volume (gal)","Absorbent price / lb","Absorption ratio (lb liquid : lb sorbent)"], formula:"sorbent lb = spill_lb / ratio; cost = lb × price/lb; compare up to 5:1 vs 2.5:1", saves:["est. product revenue","competitor / status quo"] },
  ...
  biochar:{
    ...
    spec:[
      ...
      ["Water-holding","Up to ~3–3.5× its weight (per technical report)"],
    ...
    benefits:[
      { mech:"Water-holding", b:"Honeycomb pores hold up to ~3–3.5× their weight in water, drought resilience, fewer irrigation passes, real lift in sandy/degraded soils.", who:"Farmers · ranchers · blenders · nurseries", tier:2 },
