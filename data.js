  ...
  hero:{
    ...
    slides:[
      ...
      { label:"BioSoil", img:ASSETS.heroBiosoil, pos:"50% 50%", zoom:1.05, origin:"50% 50%",
        h:"Peat performance,<br>locally sourced.",
        sub:"Ready-to-use growing media: 40% microbe-treated multipurpose fiber, 40% biochar, 20% coffee chaff. Retains water and nutrients like peat moss, zero mixing, no mined bog. Coming Q4.",
  ...
  buy:{
    ...
    products:[
      ...
      { id:"biosoil", name:"BioSoil", avail:"q4", cat:"Soil", category:"Growing Media · Peat-Moss Alternative", accent:"soil",
        claim:"Locally sourced ready-to-use growing media: 40% microbe-treated multipurpose fiber, 40% bagasse biochar, 20% coffee chaff. Behaves like peat moss, performs better.",
        uses:["Peat-moss alternative, locally sourced","Water holding & soil structure","Ready to use with no mixing"],
        ...
        bag:{ banner:"BIOSOIL · LOCALLY SOURCED GROWING MEDIA", iconSet:"soil",
          icons:["Locally Sourced","Peat-Free Alternative","Superior Water Retention","Enhanced Root Development"],
          ...
          desc:"Ready-to-use growing media blended from Louisiana-sourced materials: 40% proprietary microbe-treated multipurpose fiber, 40% carbon-negative bagasse biochar, and 20% coffee chaff. This locally sourced formula performs like peat moss—superior water holding, nutrient retention, and aeration—without mined peat bog. Ideal for potting, raised beds, landscape restoration, and growers who want peat-free performance. Coming Q4.",
      ...
      { id:"absorbent-fiber", name:"Multipurpose Fiber", avail:"q4", cat:"Absorbents", category:"Peat Moss Replacement · Loose Fiber", accent:"aqua",
        claim:"A loose fiber form—peat moss replacement engineered for spill cleanup, animal bedding, and environmental remediation.",
        uses:["Spill cleanup and remediation","Animal bedding and litter","Landfill leachate control","Peat moss alternative"],
        chips:["1 lb sample bag","Peat alternative","100% bagasse"], sampleWeight:"1 LB", photo:ASSETS.pelletsPhoto, img:ASSETS.pelletsMock, docIds:["spec"],
        bag:{ banner:"MULTIPURPOSE FIBER", iconSet:"absorbent",
          icons:["Natural Biomass","Agricultural Waste","Peat Replacement","Superior Absorption"],
          uses:"Spill Cleanup (Oil, Solvents & Non-Viscous Chemicals) | Animal Bedding & Litter | Landfill Leachate Control | Oil & Gas Fluid Remediation | Environmental Remediation | Sustainable Peat Moss Alternative",
          desc:"A renewable, peat-free alternative made from sugarcane bagasse. Our multipurpose fiber absorbs several times its own weight in liquid, outperforming wood-based absorbents, and lays down fast over a wide area. Whether for industrial spill cleanup, animal bedding, or environmental remediation, simply spread over the mess, let it fully absorb, then sweep up and dispose. Carbon-neutral, sustainably sourced, and biodegradable.",
          ingredients:"ANAEROBIC FERMENTED MICROTREATED BAGASSE", omri:false } },
