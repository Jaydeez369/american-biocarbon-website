  ...
  hero:{
    ...
    slides:[
      ...
      { label:"BioSoil", img:ASSETS.heroBiosoil, pos:"50% 50%", zoom:1.05, origin:"50% 50%",
        ...
        sub:"Blended for peat-moss performance: multipurpose fiber, biochar, and coffee chaff—retains water and nutrients like peat moss with inherent NPK, zero mixing, no mined bog. Locally sourced. Coming Q4.",
    ...
    products:[
      ...
      { id:"biosoil", name:"BioSoil", avail:"q4", cat:"Soil", category:"Growing Media · NPK-Enriched Blend", accent:"soil",
        ...
        bag:{ banner:"BIOSOIL · LOCALLY SOURCED GROWING MEDIA", iconSet:"soil",
          ...
          desc:"Ready-to-use growing media blended from Louisiana-sourced materials: proprietary microbe-treated multipurpose fiber, carbon-negative bagasse biochar, and coffee chaff. This unique formula delivers inherent nitrogen, phosphorus, and potassium alongside water retention, nutrient holding, and aeration benefits. Just add water. Ideal for potting, raised beds, landscape restoration, and growers who want a complete nutrient profile without mixing. Coming Q4.",
...
const PRODUCTS = {
  ...
  "biosoil":{
    ...
    seo:{ title:"BioSoil Growing Media, Locally Sourced Peat Alternative | American BioCarbon",
      desc:"Ready-to-use locally sourced growing media: multipurpose fiber, biochar, and coffee chaff. Peat-free performance, no mixing. Coming Q4.",
    ...
    sub:"A ready-to-use growing media blended from Louisiana-sourced materials: microbe-treated multipurpose fiber, carbon-negative biochar, and coffee chaff. Performs like peat moss—water retention, nutrient holding, aeration—with no mixing and no mined bog. Coming Q4.",
    ...
    specs:[
      ["Composition","Multipurpose fiber, biochar, and coffee chaff"],
