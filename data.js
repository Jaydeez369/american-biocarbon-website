...
const HOME = {
  ...
  hero:{
    ...
    slides:[
      ...
      { label:"Biochar-Infused Soil", img:ASSETS.heroSoil, pos:"50% 50%", zoom:1.05, origin:"50% 50%",
        ...
        primary:{label:"Stay informed",href:"/request-sample?preorder=1&product=biochar-infused-soil"}, secondary:CTA.sample },
    ]
  },
  offer:{
  ...
  buy:{
    ...
    products:[
      ...
      { id:"agricultural-biochar-mt", name:"100% Biochar", avail:"live", cat:"Biochar", category:"Soil Amendment · OMRI listed · Bulk Supply", accent:"amber",
        ...
        uses:["Soil amendment for gardens, beds, and lawns","Water and nutrient retention","Supports faster compost cycles","Carbon negative soil carbon storage"],
        chips:["Sold by the metric ton","OMRI listed","100% bagasse"], unit:"1 Metric Ton", price:450, priceLabel:"$450 / metric ton", photo:ASSETS.biocharPhoto,
        desc:"The same OMRI listed 100% bagasse biochar sold by the metric ton, ready for immediate purchase.",
      ...
      { id:"absorbent-pellets-ton", name:"Absorbent Pellets", avail:"live", cat:"Absorbents", category:"Industrial Absorbent · Bulk Supply", accent:"aqua",
        claim:"The same up to 5:1 absorption pellets sold in 2,000 lb super sacks, ready to ship now.",
        uses:["Drilling and frac fluid solidification","Oil and non-viscous chemical spill cleanup","Landfill leachate and aqueous waste","Animal bedding and pet litter"],
        chips:["Sold in 2,000 lb super sacks","100% bagasse","Low dust"], unit:"1 US Ton", packaging:"2,000 lb super sacks", price:275, priceLabel:"$275 / US ton", photo:ASSETS.pelletsPhoto,
        desc:"The same up to 5:1 absorption sugarcane bagasse pellets sold in 2,000 lb super sacks, ready for immediate purchase.",
      ...
      { id:"absorbent-crumble-ton", name:"Absorbent Crumble", avail:"live", cat:"Absorbents", category:"Industrial Absorbent · Bulk Supply", accent:"aqua",
        claim:"The same coarse grade crumble sold in 2,000 lb super sacks, ready to ship now.",
        ...
        chips:["Sold in 2,000 lb super sacks","Coarse grade","100% bagasse"], unit:"1 US Ton", packaging:"2,000 lb super sacks", price:275, priceLabel:"$275 / US ton", photo:ASSETS.pelletsPhoto, gallery:[ ASSETS.pelletsPhoto ],
        desc:"The same up to 5:1 absorption sugarcane bagasse crumble sold in 2,000 lb super sacks, ready for immediate purchase.",
        sections:[
          { h:"Large area spill cleanup", body:"Broadcast the crumble across the spill in fewer passes than a fine sorbent needs, let it fully absorb, then sweep up and dispose of the saturated material per your local requirements." },
          { h:"Waste solidification", body:"An up to 5:1 absorption ratio solidifies aqueous and oilfield waste with less sorbent mass, so crews open fewer bags and haul away less material." },
        ],
  ...
  feature:{
    ...
    body:"Solidify drilling and frac fluids, clean up oil and non-viscous chemical spills, and control landfill leachate with a renewable sorbent that cuts bag count and disposal weight. Available in bulk, by the US ton in 2,000 lb super sacks, and in truckload volumes, with spec sheets on request.",
    bullets:[
...
const PRODUCTS = {
  "absorbent-pellets":{
    ...
    specs:[
      ...
      ["Availability","Free 1 lb samples now; bulk & 2,000 lb super sack supply"],
      ["Dust","Low"],
  ...
  "absorbent-crumble":{
    ...
    seo:{ title:"Absorbent Crumble, Fast, Broad Coverage Bagasse Sorbent | American BioCarbon",
      desc:"A coarser bagasse absorbent crumble for large area and high volume spills. Spreads fast, holds up to 5× its weight. Free 1 lb samples ship now, with US ton supply in 2,000 lb super sacks.",
    ...
    sub:"A coarser bagasse form that spreads quickly across large area and high volume spills, same up to 5:1 performance, faster to lay down. Free 1 lb samples ship now, with US ton supply in 2,000 lb super sacks.",
    ...
    specs:[
      ...
      ["Form factors","1 lb sample bag · US ton in 2,000 lb super sacks · bulk"],
      ["Availability","Free 1 lb samples ship now; US ton supply in 2,000 lb super sacks"],
      ["Documentation","Spec sheet on request"],
    ],
    comparison:{ h:"Vs the status quo",
    ...
    faq:[
      ...
      { q:"Can I get a sample, and what volumes are available?", a:"Yes, free 1 lb samples ship now (4 to 7 business days) so you can test against your current absorbent. US ton supply, packaged in 2,000 lb super sacks, is available for immediate purchase, with FOB bulk bags ready in 7-10 business days, and truckload supply is on request." },
  ...
  "absorbent-fiber":{
    ...
    specs:[
      ...
      ["Form factors","Bulk · US ton in 2,000 lb super sacks"],
    ...
    faq:[
      ...
      { q:"When is volume supply available?", a:"Free 1 lb samples ship now (4 to 7 business days). Bulk and US ton supply in 2,000 lb super sacks comes online with our Q4 capacity ramp, so you can reserve supply and lock pricing now." },
    ],
    form:"quote",
...
const FORMS = {
  ...
  quote:{
    ...
    fields:[
      ...
      { n:"format", label:"Format", type:"select", req:false, options:["Bulk","2,000 lb super sack (absorbents)","1 metric ton bulk bag (biochar)","20/40 lb bags","Truckload","Not sure"] },
