...
const PRODUCTS = {
  ...
  "agricultural-biochar":{
    ...
    fieldApps:[
      { title:"Soil amendment for sandy &amp; degraded soils", detail:"Water &amp; nutrient retention",
        body:"Work biochar into sandy or degraded soils to hold water and nutrients in the root zone.",
        benefit:"Holds up to ~3 to 3.5× its weight in water, retained for the crop." },
      { title:"Compost acceleration &amp; bulking", detail:"Windrow throughput",
        body:"Blend into windrows to raise pile temperature and shorten turnover time.",
        benefit:"Research shows ~10 to 30% shorter cycles (validate in your process), more batches per pad." },
      { title:"Premium blend component", detail:"Potting &amp; growing media",
        body:"Add to potting and growing mixes for peat like water holding and aeration.",
        benefit:"A differentiated, carbon negative input for premium blends." },
      { title:"Nursery &amp; greenhouse media", detail:"Containers &amp; propagation",
        body:"Amend container and propagation media to steady moisture and nutrient availability.",
        benefit:"More even moisture between waterings." },
      { title:"Row crop &amp; specialty ag trials", detail:"Field scale evaluation",
        body:"Run field scale trials on row and specialty crops to measure water and yield response.",
        benefit:"OMRI listed input with a documented spec for trials." },
    ],
    specs:[
