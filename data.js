  ...
  buy:{
    ...
    products:[
      ...
      { id:"absorbent-fiber", name:"Multipurpose Fiber", avail:"q4", cat:"Absorbents", category:"Peat Moss Replacement · Locally Sourced", accent:"aqua",
        claim:"Louisiana-sourced loose fiber for spill cleanup, animal bedding, and soil amendment—a renewable peat-moss alternative. Coming Q4.",
        uses:["Loose fiber for multiple applications","Animal bedding and litter","Spill cleanup and remediation","Renewable peat alternative"],
        ...
        bag:{ banner:"MULTIPURPOSE FIBER · LOCALLY SOURCED", iconSet:"absorbent",
          ...
          desc:"Louisiana-sourced, microbe-treated bagasse multipurpose fiber—a renewable peat-moss alternative engineered for versatility. Absorbs several times its own weight in liquid, outperforming wood-based absorbents, and spreads fast over wide areas. Use for industrial spill cleanup, animal bedding, or as a renewable soil amendment. Simply spread over the mess, let it fully absorb, then sweep up and dispose. Carbon-neutral, sustainably sourced, biodegradable, and locally grown.",
...
const PRODUCTS = {
  ...
  "absorbent-fiber":{
    ...
    sub:"Louisiana-sourced, microbe-treated loose bagasse fiber—a renewable peat-moss alternative that works across spill cleanup, animal bedding, and soil amendment. Coming Q4.",
    primary:CTA.quote, secondary:CTA.sample, tertiary:CTA.sds, image:ASSETS.pelletsPhoto, mock:ASSETS.pelletsMock,
    ...
    problem:{ h:"Growers and crews want one renewable fiber that does more than one job",
      body:"Mined peat drains wetlands, and wood-based absorbents and beddings underperform on capacity and sustainability. Buyers end up sourcing separate materials for bedding, spill cleanup, and soil work—each with its own supply chain and footprint." },
    ...
    faq:[
      { q:"Can one material really cover bedding, cleanup, and soil?", a:"Yes—it's the same bagasse fiber. Use it loose for animal bedding, spread it for spill cleanup, or work it into soil as a renewable peat alternative." },
      { q:"When is volume supply available?", a:"Free 1-lb samples ship now (4 to 7 business days). Bulk and one-metric-ton bulk-bag supply comes online with our Q4 capacity ramp; reserve supply and lock pricing now." },
    ],
    form:"quote",
