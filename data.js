...
const PRODUCTS = {
  "absorbent-pellets":{
    ...
    fieldApps:[
      { title:"Drilling &amp; frac fluid solidification", detail:"Reserve pits, tanks &amp; produced water",
        body:"Solidify aqueous drilling and frac fluids so free liquid becomes a handleable solid ahead of pit closeout and disposal.",
        benefit:"Locks up the same fluid with up to about half the sorbent mass." },
      { title:"Oil &amp; fuel spill cleanup", detail:"Targeted spills on hard surfaces",
        body:"Sprinkle over oil and fuel spills on pads, floors, and pavement, let it absorb, then sweep up and dispose.",
      ...
      { title:"Non-viscous chemical &amp; aqueous spills", detail:"Process leaks &amp; washdown",
        body:"Absorb non-viscous chemical releases and aqueous washdown before they spread or reach a drain.",
      ...
      { title:"Landfill leachate &amp; aqueous waste", detail:"Free liquids solidification",
        body:"Solidify leachate and aqueous waste so loads meet free liquids limits before transport and disposal.",
        benefit:"Less saturated tonnage leaves the gate each cycle." },
      { title:"Flood &amp; disaster cleanup", detail:"Standing water &amp; wet debris",
        body:"Knock down standing water and saturate wet debris during flood and disaster response.",
  ...
  "absorbent-crumble":{
    ...
    fieldApps:[
      { title:"Large area spill coverage", detail:"Wide footprint events",
        body:"Lay crumble down quickly across large spills so a migrating spill is contained in fewer passes.",
        benefit:"Covers more ground per pass, cutting spread labor." },
      { title:"Drilling &amp; frac fluid solidification", detail:"Pits &amp; high volume streams",
        body:"Solidify high volume aqueous drilling and frac fluids where speed of coverage matters most.",
        benefit:"Fast knockdown of large fluid volumes." },
      { title:"High volume &amp; storm events", detail:"Surge and overflow",
        body:"Absorb surge volume during storm, overflow, and high throughput events across a wide area.",
        benefit:"Rapid, broad coverage keeps systems within capacity." },
      { title:"Disaster &amp; flood cleanup", detail:"Standing water &amp; debris",
        body:"Spread across flooded areas to solidify standing water and wet debris for removal.",
        benefit:"Broad coverage firms wet material fast." },
      { title:"Industrial washdown areas", detail:"Yard &amp; bay floors",
        body:"Cover washdown bays and yard floors to capture non-viscous runoff across a wide footprint.",
  ...
  "absorbent-fiber":{
    ...
    fieldApps:[
      { title:"Animal bedding &amp; litter", detail:"Loose fast spreading fiber",
        body:"Spread the loose fiber as bedding across stalls, pens, and litter areas for fast, even coverage.",
        benefit:"Absorbs several times its weight in liquid to keep bedding dry." },
      { title:"Spill cleanup", detail:"Oil, solvents &amp; non-viscous chemicals",
        body:"Broadcast over spilled oil, solvents, and non-viscous chemicals to soak up free liquid on contact.",
        benefit:"Fast, broad coverage captures spills for easier recovery." },
      { title:"Landfill leachate control", detail:"Aqueous liquid capture",
        body:"Apply to leachate and other aqueous liquids to bind free water into a handleable solid.",
        benefit:"Locks up several times its weight in liquid to cut haul volume." },
      { title:"Oil &amp; gas fluid remediation", detail:"Field &amp; site cleanup",
        body:"Spread over oil and gas fluid releases during environmental remediation to recover free liquid.",
        benefit:"Renewable, biodegradable sorbent that covers wide areas fast." },
      { title:"Soil amendment &amp; peat replacement", detail:"Renewable mined peat alternative",
        body:"Work the bagasse fiber into soil and growing mixes as a replacement for mined peat and wood.",
        benefit:"Carbon neutral, locally grown input that holds moisture in the root zone." },
    ],
    specs:[
  ...
  "agricultural-biochar":{
    ...
    fieldApps:[
      { title:"Physical Habitat for Fungal Networks", detail:"Mycorrhizal shelter",
        body:"Biochar's highly porous, stable structure provides microscopic shelters for mycorrhizal fungi and other beneficial microbes.",
        benefit:"Up to 80% higher mycorrhizal colonization rates in biochar-amended soils." },
      { title:"Improved Soil Structure &amp; Root Penetration", detail:"Lower bulk density",
        body:"By reducing soil bulk density, biochar allows roots to grow deeper and wider.",
        benefit:"Supports the expansion of mycorrhizal networks through the root zone." },
      { title:"Nutrient Retention &amp; Availability", detail:"Root-zone nutrients",
        body:"Biochar holds nutrients in the root zone, reducing leaching and keeping minerals in reach.",
        benefit:"Makes phosphorus and other minerals more biologically available to mycorrhizal fungi." },
      { title:"pH &amp; Moisture Benefits", detail:"Buffered environment",
        body:"Biochar helps buffer soil pH, creating a more stable environment for mycorrhizal fungi, which often thrive in slightly acidic to neutral conditions.",
        benefit:"A steadier pH and moisture profile in the root zone." },
      { title:"Synergistic Effects in Agriculture", detail:"Biochar + inoculation",
        body:"Research shows that combining biochar with mycorrhizal inoculation can improve soil health, crop productivity, and climate resilience.",
        benefit:"Compounding gains in soil health, productivity, and resilience." },
    ],
    specs:[
  ...
  "carbon-removal":{
    ...
    fieldApps:[
      { title:"Corporate net zero procurement", detail:"Audit ready removal portfolios",
        body:"Source durable removal tons for a net zero or SBTi aligned program that has to withstand audit.",
        benefit:"Puro.earth CORCs tied to physical deployment with a full MRV trail." },
      { title:"Carbon broker sourcing", detail:"Durable supply for resale",
        body:"Add a verifiable, deployment backed removal product to a brokerage portfolio.",
        benefit:"Real tons with permanence you can stand behind to buyers." },
      { title:"Forward purchase contracts", detail:"Pipeline matched offtake",
        body:"Contract forward volumes sized conservatively to our documented deployment schedule.",
        benefit:"We never sell more credits than deployable tons." },
    ],
    specs:[
  ...
  "distributors":{
    ...
    fieldApps:[
      { title:"Grower water efficiency programs", detail:"Drought &amp; irrigation accounts",
        body:"Stock the raw biochar for growers cutting irrigation cost, since it holds up to ~3 to 3.5× its weight in water.",
      ...
      { title:"Compost &amp; soil blend accounts", detail:"Blenders &amp; municipal yards",
        body:"Sell biochar into your compost and blend accounts as a bulk consumed input that can shorten compost cycles ~10 to 30% (validate in your process).",
        benefit:"Faster turns pull larger repeat volumes through your yard." },
      { title:"Organic &amp; regenerative lines", detail:"OMRI listed shelf placement",
        body:"Slot the OMRI listed, carbon negative line into your organic and regenerative aisle with inherent NPK plus Ca/Mg.",
        benefit:"Fills a certified input gap and holds margin against commodity amendments." },
      { title:"Nursery, landscape &amp; retail SKUs", detail:"Ready to use bagged soil",
        body:"Carry the biochar-infused ready to use soil as a bagged retail SKU for nursery, landscape, and garden center buyers.",
      ...
      { title:"Co-branded grower trials", detail:"De-risked stocking &amp; proof",
        body:"Run co-branded field trials with target growers before committing shelf space, using their own yield and water data.",
        benefit:"Local proof de-risks the stocking decision and converts trial acres to orders." },
    ],
  ...
  "soil-blenders":{
    ...
    fieldApps:[
      { title:"Compost cycle acceleration", detail:"Windrow turnover",
        body:"Blend biochar into windrows to raise pile temperature and shorten days to maturity.",
        benefit:"Research shows ~10 to 30% shorter cycles (validate in your process), more batches per pad." },
      { title:"Windrow bulking &amp; moisture", detail:"Structure &amp; aeration",
        body:"Use biochar to bulk windrows and steady moisture through the compost cycle.",
        benefit:"More consistent moisture and airflow across the pile." },
      { title:"Premium blend water holding", detail:"Sandy &amp; premium mixes",
        body:"Add to premium and sandy blends to firm up moisture performance in the bag.",
        benefit:"Holds up to ~3 to 3.5× its weight in water in blends." },
      { title:"Organic / carbon negative SKU", detail:"Differentiated product line",
        body:"Offer an OMRI listed, carbon negative blend component that growers ask for by name.",
        benefit:"A demand driver SKU instead of a price race commodity." },
      { title:"Side by side trial validation", detail:"Prove it on your pad",
        body:"Run a biochar amended windrow or blend against a control on the same recipe and schedule.",
        benefit:"Measure days to maturity and moisture yourself before scaling." },
    ],
