...
function carbonPillar(c){
  return `<section class="block carbon-pillar"><div class="wrap">
    <div class="cp-grid">
      <div class="cp-lead">
        <div class="kicker" style="color:#5cc4d6">${raw(c.kicker)}</div>
        <h2>${raw(c.h)}</h2>
...
function industryTech(id){
  ...
  return `<section class="block" style="background:var(--graphite);color:#edeff2"><div class="wrap">
    <div class="kicker" style="color:#a7b1bf">Technical Data · gated</div>
    <h2 style="color:#fff;font-size:26px;margin:8px 0 10px">Documentation for your application</h2>
    <p style="color:#cdd3db;max-width:640px">${raw(TECH.gateNote)}</p>
...
function truckScene(accent, label){
  const c = { aqua:{a:"#17b3a3",b:"#0c7d72",ink:"#06403a"}, amber:{a:"#f0a63a",b:"#d0781a",ink:"#7a3f06"}, soil:{a:"#8a9a5b",b:"#5f6f39",ink:"#333d1e"} }[accent] || {a:"#6a7486",b:"#323a4a",ink:"#171b22"};
