...
const CTA = {
  sample:  { label:"Get a free sample",         href:"#/request-sample" },
  quote:   { label:"Talk to us about volume",       href:"#/request-quote" },
  spec:    { label:"Download Spec Sheet",           href:"#/request-docs?doc=spec" },
  ...
  compare: { label:"Compare Against Wood Pellets",  href:"#/compare" },
...
const NAV = [
  { label:"Absorbents", children:[
    ...
    { label:"Compare vs Wood Pellets", href:"#/compare" },
  ]},
  { label:"Industries", children:[
    { label:"Oil & Gas Remediation", href:"#/industry/oil-gas" },
  ...
  { label:"Agriculture", children:[
    ...
    { label:"Distributors & Resellers", href:"#/industry/distributors" },
...
const TECH = {
  ...
  // Document catalog, the gated deliverables
  docs:[
    { id:"abs-spec", name:"Absorbent Pellets & Crumble, Spec Sheet", cat:"Absorbents", desc:"Absorbency ratio, bulk density, granulation, form factors." },
    ...
    { id:"bio-spec", name:"100% Biochar, Spec Sheet", cat:"Agriculture", desc:"Organic carbon, water-holding, NPK, particle size." },
  ...
  studies:[
    { title:"Multi-Year Field Application of Sugarcane Bagasse Biochar", authors:"Lima, White & Webber, USDA-ARS", venue:"US Biochar Initiative Conference, 2019", type:"field",
      finding:"Multi-year Louisiana field trials evaluating bagasse and cane-trash biochar effects on sugarcane and soil.", note:"Specific to sugarcane bagasse biochar." },
    { title:"Biochar addition reduces nitrogen loss and accelerates the composting process", authors:"Bioresource Technology", venue:"Elsevier, 2021", type:"peer",
      finding:"Biochar shortened the composting cycle and reduced nitrogen loss by shifting the core microbial community.", note:"General biochar research." },
    { title:"Enhancing composting efficiency using biochar amendments", authors:"Scientific Reports", venue:"Nature, 2025", type:"peer",
      finding:"Biochar raised pile temperature and accelerated maturation while cutting greenhouse-gas emissions.", note:"General biochar research." },
    { title:"Biochar's effect in the composting mechanism: a review", authors:"Bioresource Technology", venue:"Elsevier, 2023", type:"peer",
      finding:"Review: biochar shortens time to thermophilic phase, raises peak temperature, and speeds organic-matter degradation.", note:"General biochar research." },
    { title:"ProGreaux Bagasse Biochar, IBI Laboratory Analyses", authors:"Control Laboratories", venue:"IBI Certification Program", type:"lab",
      finding:"Independent IBI panels: organic carbon 58 to 65%, H/C < 0.7, surface area ~230 to 260 m²/g, heavy metals well below thresholds.", note:"Product-specific lab data." },
  ],
  ...
  hero:{
    ...
    slides:[
      ...
      { label:"100% Biochar", img:ASSETS.hands, pos:"50% 50%", zoom:1.06, origin:"50% 55%",
        ...
        primary:CTA.biochar, secondary:CTA.spec },
      ...
      { label:"BioSoil", img:ASSETS.heroBiosoil, pos:"50% 50%", zoom:1.05, origin:"50% 50%",
        ...
        primary:CTA.biochar, secondary:CTA.distributor },
    ],
  },
  offer:{
  ...
  buy:{
    ...
    products:[
      ...
      { id:"biosoil", name:"BioSoil", avail:"q4", cat:"Soil", category:"Growing Media · Peat-Moss Alternative", accent:"soil",
        claim:"A peat-moss style growing media made with about 40 percent bagasse biochar, microbe-treated bagasse fiber, and coffee chaff. It behaves similar to peat moss.",
        uses:["Peat-moss alternative for growers","Water holding and soil structure","Ready to use with no mixing"],
        chips:["½ lb sample bag","Microbe-treated fiber","Peat-moss alternative"], sampleWeight:"½ LB", photo:ASSETS.biocharLg,
        bag:{ banner:"HIGH NPK 3-3-3 BIOSOIL", iconSet:"soil",
          icons:["Natural Biomass","Agricultural Waste","Superior Water Retention","Enhanced Root Development"],
          ...
          desc:"Premium 100% organic soil conditioner and growing media formulated to improve plant growth, water retention, and nutrient availability. Made from nutrient-rich bagasse compost, biochar, and organic amendments, this balanced 3-3-3 NPK blend is ideal for vegetables while enhancing soil health, microbial activity, and moisture retention. Ideal for agriculture, landscaping, greenhouse production, and home gardens. Carbon capture amount: Pending Calculation.",
      ...
      { id:"absorbent-crumble", name:"Absorbent Crumble", avail:"q4", cat:"Absorbents", category:"Industrial Absorbent · Large-Area Spills", accent:"aqua",
        ...
        bag:{ banner:"ABSORBENT CRUMBLE", iconSet:"absorbent",
          ...
          ingredients:"MICROBE TREATED SUGARCANE BAGASSE", omri:false } },
      { id:"absorbent-fiber", name:"Absorbent Fiber", avail:"q4", cat:"Absorbents", category:"Industrial Absorbent · Loose Fiber", accent:"aqua",
        claim:"A loose bagasse fiber form of our carbon-neutral absorbent for broad, fast coverage.",
        uses:["Spill cleanup and remediation","Animal bedding","Landfill leachate control"],
        chips:["1 lb sample bag","Loose fiber","100% bagasse"], sampleWeight:"1 LB", photo:ASSETS.pelletsPhoto, img:ASSETS.pelletsMock, docIds:["spec"],
        bag:{ banner:"ABSORBENT FIBER", iconSet:"absorbent",
          icons:["Natural Biomass","Agricultural Waste","Naturally Absorbent Fibers","Superior Liquid Retention"],
          uses:"Spill Cleanup (Oil, Solvents & Non-Viscous Chemicals) | Animal Bedding | Landfill Leachate Control | Oil & Gas Fluid Remediation (Drilling & Fracking) | Flood & Natural Disaster Cleanup",
          desc:"A carbon-neutral, plant-based absorbent made from sugarcane bagasse in a loose fiber form. It soaks up several times its own weight in liquid, outperforming standard wood-based absorbents, and lays down fast over a wide area. Spread over the mess, let it fully absorb, then sweep up and dispose. Renewable, sustainably sourced, and built for tough industrial and household jobs.",
          ingredients:"MICROBE TREATED SUGARCANE BAGASSE", omri:false } },
...
const PRODUCTS = {
  ...
  "carbon-removal":{
    ...
    sub:"Puro.earth-certified CORCs generated when our biochar is physically deployed, backed by measurement, reporting, and verification, not paper offsets.",
    primary:CTA.carbon, secondary:CTA.specialist, tertiary:CTA.spec, image:ASSETS.hands, mock:ASSETS.biocharMock,
    proofRow:["Puro.earth certified","H/C < 0.7 · durable carbon","Deployment-backed + MRV","Forward purchase available"],
    problem:{ h:"Buyers need removal that survives scrutiny",
      body:"Corporate and broker buyers are under pressure to source durable, additional, verifiable carbon removal, and to defend every ton to auditors and regulators. Many credits are paper avoidance offsets with uncertain permanence, the kind that get written down or retired-in-doubt when scrutinized, leaving the buyer to re-purchase." },
    explanation:{ h:"Real tons, documented",
      body:"Our biochar locks carbon into a stable form (H/C molar ratio below 0.7) that persists long-term. Credits are issued through Puro.earth and tied to documented, physical deployment of product, so supply is grounded in real tons moved, with an MRV trail." },
    useCases:["Corporate net-zero procurement","Carbon broker sourcing","Marketplace supply","Forward purchase tied to deployment pipeline"],
    specs:[
      ["Standard","Puro.earth CORC methodology"],
      ["Durability","H/C molar ratio <0.7 (long-term storage)"],
      ["Basis","Documented physical biochar deployment"],
      ["Structure","Spot or forward purchase"],
    ],
    comparison:{ h:"Vs generic credits",
      cols:["","Our CORCs","Generic credits"],
      rows:[["Basis","Deployed physical tons","Often paper/avoidance"],["Durability","Biochar-stable, H/C<0.7","Variable"],["Verification","Puro + MRV","Varies"]] },
    faq:[
      { q:"How much CO₂ per ton?", a:"We share verified, methodology-specific figures during diligence rather than a blanket number, request carbon removal information and we'll provide current data." },
      { q:"Can we do a forward purchase?", a:"Yes, sized conservatively to our deployment pipeline, we don't sell more credits than deployable tons." },
    ],
    form:"carbon",
    internal:["#/product/agricultural-biochar","#/about","#/technical"],
  },
};
...
const FORMS = {
  sample:{
    ...
    fields:[
      ...
      { n:"buyerType", label:"Buyer type", type:"select", req:false, options:["Oilfield services","Spill response","Environmental remediation","Landfill / waste","Municipal / disaster","Industrial operations","Other"], otherPh:"e.g. Marine terminal, Mining, Pipeline" },
  ...
  quote:{
    ...
    fields:[
      ...
      { n:"product", label:"Product", type:"select", req:true, options:["Absorbent Pellets","100% Biochar","BioSoil","Absorbent Crumble","High Seas Biochar","Multiple / not sure"] },
  ...
  docs:{
    ...
    fields:[
      ...
      { n:"industry", label:"Industry / application", type:"select", req:true, options:["Oil & gas","Spill response","Environmental remediation","Landfill / leachate","Municipal / disaster","Agriculture / distribution","Soil blending / compost","Carbon / ESG","Other"], otherPh:"e.g. Marine, Mining, Pipeline" },
